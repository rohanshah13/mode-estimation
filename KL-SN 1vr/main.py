...
parser = argparse.ArgumentParser(description='KL-SN-1vr method for mode estimation for sampling with replacement')
...
[numSamples, success, time_taken] = KLSN2.KL_SN2(numberIterations, randomSeed,
...
write_data('KLSN-1vr',avgSamples, se, args.delta, failure_probability, args.random_seed, args.outfile)
