...
[numSamples, success, time_taken] = KLSN2EVE_seed.KL_SN2EVE(numberIterations, randomSeed,
...
write_data_seed('KLSN-1v1',numSamples, args.delta, success, args.outfile)
