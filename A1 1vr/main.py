...
[numSamples, success, time_taken] = sequentialEstimation.sequentialEstimation(numberIterations, randomSeed,
...
write_data('A1-1vr',avgSamples, se, args.delta, failure_probability, args.random_seed, args.outfile)
