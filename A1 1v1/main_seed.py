import json
import sequentialEstimationEVE_seed
import numpy as np
import os
import sys
import argparse
...
parser = argparse.ArgumentParser(description='A1-1v1 method for mode estimation for sampling with replacement')
...
[numSamples, success, time_taken] = sequentialEstimationEVE_seed.sequentialEstimationEVE(numberIterations, randomSeed,
...
write_data_seed('A1-1v1',numSamples, args.delta, success, args.outfile)
