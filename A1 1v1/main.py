import sequentialEstimationEVE
import numpy as np
import os
import sys
import argparse
...
[numSamples, success, time_taken] = sequentialEstimationEVE.sequentialEstimationEVE(numberIterations, randomSeed,
...
write_data('A1-1v1',avgSamples, se, args.delta, failure_probability, args.random_seed, args.outfile)
